...
<strong>Possible Future Enhancements:</strong> Create a temporary file to remember the last settings in order to override the hardcoded values in case the printer gets replaced or this app is used in antoher house-network.
